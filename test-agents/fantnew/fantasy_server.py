...
def setup_logging(log_file: str | os.PathLike = DEFAULT_LOG_FILE):
    ...
    # Make sure the parent directory exists so logging doesn't crash
...
def create_server(logger: logging.Logger) -> Server:
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Fantasy Baseball MCP Server")
    parser.add_argument(
        "--log-file",
        default=os.environ.get("FANTASY_BASEBALL_LOG_FILE", DEFAULT_LOG_FILE),
        help=(
            "Path to the log file. Can also be set via the "
            "FANTASY_BASEBALL_LOG_FILE env var. "
