...
class FantasyBaseballTools:
    ...
    def get_player_data(self, player_id: int, season: Optional[int] = 2026) -> Dict[str, Any]:
        """
    ...
    def get_multiple_players_data(self, player_ids: List[int], season: Optional[int] = 2026) -> Dict[str, Any]:
        """
    ...
    def get_league_leaders(self, stat_type: str, season: Optional[int] = 2026) -> Dict[str, Any]:
        """
